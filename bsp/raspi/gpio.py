...
def init_gpio():
    ...
    _VLD = gpiozero.DigitalInputDevice(config.PIN_IN_VLD, pull_up=True, bounce_time=0.02)
    _INTERCOM = gpiozero.DigitalInputDevice(config.PIN_IN_INTERCOM_RELAY1, pull_up=True, bounce_time=0.02)
